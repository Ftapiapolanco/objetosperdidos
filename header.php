...
<div class="container-fluid">
    ...
    <div class="headernav">
        <div class="container">
            <div class="row">
                <div class="col-lg-1 col-xs-3 col-sm-2 col-md-2 logo "><a href="index.php"><img src="images/logo_devtic.jpg" alt=""  /></a></div>
                ...
                <div class="col-lg-4 search hidden-xs hidden-sm col-md-3">
                    <div class="wrap">
                        <form action="#" method="post" class="form">
                            <div class="pull-left txt"><input type="text" class="form-control" placeholder="Buscar tema"></div>
                ...
                <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                    <div class="stnt pull-left">
                        <form action="nuevapublicacion.php" method="post" class="form">
                    ...
                    <div class="avatar pull-left dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <!--<li role="presentation"><a role="menuitem" tabindex="-2" href="#">Mensajes</a></li>-->
                            <li role="presentation"><a role="menuitem" tabindex="-3" href="#">Cerrar sesión</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-4" href="nuevacuenta.php">Crear cuenta</a></li>
                        </ul>
                    </div>
